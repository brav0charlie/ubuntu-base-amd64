# file: zsh/config.zsh
# description: main config options for ZSH
...
# Do not notify of background job status immediately upon changes
unsetopt notify
...
unsetopt complete_aliases         # the opposite of above
unsetopt completealiases          # Unclear on syntax here, adding this just for good measure
